...
userRouter
    .route("/")
    .patch((req, res) => new user_controller_1.UserController().updateOne(req, res));
userRouter
    .route("/login")
    .post((req, res) => new user_controller_1.UserController().login(req, res));
userRouter
    .route("/adminLogin")
    .post((req, res) => new user_controller_1.UserController().adminLogin(req, res));
userRouter
    .route("/register")
...
userRouter
    .route("/all")
    .get((req, res) => new user_controller_1.UserController().getAll(req, res));
userRouter
    .route("/")
    .delete((req, res) => new user_controller_1.UserController().deleteOne(req, res));
